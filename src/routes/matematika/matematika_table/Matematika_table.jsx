                ...
                <div className="informatika_bottom_contents">
                    <div className="informatika_left_divs">
                        ...
                        <p className="informatika_left_divs_text2">
                            {
                                language === "UZ" ? "1.Sheraliyev Sardor" : "1. Sardar Sheraliyev"
                            }
                        </p>
                        <p className="informatika_left_divs_text2">
                            {
...
export default Matematika_table