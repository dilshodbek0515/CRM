            ...
            <div className="Exist_group">
                <div className="exist_content_top">
                    <p className="exist_content_top_text">
                        {
                            language === "UZ" ? "Mavjud guruhlar" : "Available groups"
                        }
                    </p>
                    <form className="exist_form">
                        <button className="exist_btn"><GrSearch /></button>
                        <input className="exist_search_input" type="search" placeholder={
                            language === "UZ" ? "Guruh nomini kiriting" : "Enter a group name"
                        } required />
                    </form>
                </div>

                <div className="exist_bottom">
                    <Link to="/Matematika" className="exist_card">
                    ...
                    <Link to="/Onatili" className="exist_card">
                        <div className="exist_card_top_content">
                            {
                    ...
                    <Link to="/Informatika" className="exist_card">
                        <div className="exist_card_top_content">
                            {
                    ...
                    <Link to="Fizika" className="exist_card">
                        <div className="exist_card_top_content">{language === "UZ" ? "Fizika" : "Physics"}</div>
                        <div className="exist_card_bottom_content">
                            <div className="exist_top_div">
                                <img className="exist_img" src={exitimg} alt="exist_img" />
                                <div className="exist_top_img_div">
                    ...
                    <Link to="/Kimyo" className="exist_card">
                        <div className="exist_card_top_content">
                            {
                    ...
                    <Link to="/Tarix" className="exist_card">
                        <div className="exist_card_top_content">{language === "UZ" ? "Tarix" : "History"}</div>
                        <div className="exist_card_bottom_content">
                            <div className="exist_top_div">
                                <img className="exist_img" src={exitimg2} alt="exist_img" />
                                <div className="exist_top_img_div">
