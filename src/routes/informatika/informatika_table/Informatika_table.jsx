                            ...
                            <div className="exist_card_bottom_content">
                                <div className="exist_top_div">
                                    ...
                                    <div className="exist_top_img_div">
                                        <p className="exist_top_text1"><span className="sxist_span">O’qituvchi: </span>Muxamadaliyev Ibroxim</p>
                                        <p className="exist_top_text2"><span className="sxist_span">Tell raqam: </span>+998900113861</p>
                                    </div>
                                </div>
                                <div className="exist_bottom_div">
                                    <p className="exist_bottom_div_texts1"><span className="sxist_span1">Dars kunlari:</span>DU-CHOR-JUMA</p>
                                    <p className="exist_bottom_div_texts2"><span className="sxist_span2">Dars vaqti:</span>14:00-16:00</p>
                                    <p className="exist_bottom_div_texts3"><span className="sxist_span3">O’quvchilar soni</span>25ta</p>
                                    <p className="exist_bottom_div_texts4"><span className="sxist_span4">To’lov qilganlar</span>10ta</p>
                                </div>
                            </div>
                        </div>
                        <p className="informatika_left_divs_text1">Shu oy bo’yicha to’lov qilmaganlar </p>
                        <p className="informatika_left_divs_text2">1.Muxamadaliyev Ibroxim</p>
                        <p className="informatika_left_divs_text2">2.Muxamadaliyev Ibroxim</p>
                        <p className="informatika_left_divs_text2">3.Muxamadaliyev Ibroxim</p>
                    </div>

                    <div className="informatika_right_divs">
                        <div className="informatika_right_cards1">
                            <p className="informatika_right_cards_text11">№</p>
                            <p className="informatika_right_cards_text22">O’quvchi ismi</p>
                            <p className="informatika_right_cards_text3">To’lov</p>
                        </div>
                        <div className="informatika_right_cards">
                            <p className="informatika_right_cards_text1">1</p>
                            <p className="informatika_right_cards_text2">Muxamadaliyev Ibroxim</p>
...
export default Informatika_table
