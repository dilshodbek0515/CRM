import "./Checked4_table.css"
import exitimg from "../../../assets/image/exit img.png"
import { useState } from "react";

const Checked_table4 = ({ language }) => {
        ...
        <div className="informatika_divs">
            <div className='Informatika_tabless'>
                <p className="informatika_one_text">
                    {
                        language === "UZ" ? "Fizika guruhi ro’yhati" : "Physics group list"
                    }
                </p>
